...
def parse_args():
    ...
    parser.add_argument('--precision', type=str, default='int8', help='precision control')
    parser.add_argument('--config', type=str, default='work_dirs/no_spconv/bevfusion_yx_kl.py', help='Config file')
    parser.add_argument('--checkpoint', type=str, default='work_dirs/no_spconv/epoch_20.pth', help='Checkpoint file')
