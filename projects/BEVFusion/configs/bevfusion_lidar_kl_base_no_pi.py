...
model = dict(
    ...
    bbox_head=dict(
        ...
        train_cfg=dict(
            ...
            # Baseline config: disable pi-symmetric rotation target
            # selection so all classes use the original yaw label.
...
val_evaluator = dict(
    ...
    # Keep the same pi-symmetric metric as the pi-training config. This makes
    # the ablation isolate training-time target selection only.
