...
model = dict(
    ...
    # Use pure image-based LSS for the camera branch. LiDAR is still used by
    # the LiDAR branch and later BEV fusion, but not as sparse depth guidance
    # inside the camera view transform.
    view_transform=dict(
        type='LSSTransform',
        in_channels=256,
        out_channels=80,
...
train_pipeline = [
    ...
    dict(
        ...
        classes=[
            ...
            'ContainerForklift', 'Forklift', 'Lorry',
            'ConstructionVehicle', 'WheelCrane'
        ]),
    dict(
        type='GridMask',
        use_h=True,
